    ...
    return (
        <div className="flex flex-col justify-center items-center bg-white h-screen md:absolute md:top-0 w-full z-0">
            <div className="mx-auto flex w-full flex-col justify-center px-5 pt-0 md:max-w-1/2 lg:h-screen min-h-screen lg:max-w-1/2 lg:px-6">
                ...
                <p className="text-2xl font-bold text-zinc-950 dark:text-white">Sign In</p>
                ...
                <div>
                    ...
                    <p><Link href="/forgot-password" className="font-medium text-zinc-950 dark:text-white text-sm">Forgot your password?</Link></p>
                    <p><Link href="/sign-up" className="font-medium text-zinc-950 dark:text-white text-sm">Don&apos;t have an account? <span className="text-blue-500">Sign up</span></Link></p>
                </div>
                </div>
            </div>
        </div>
