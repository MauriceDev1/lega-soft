...
export default function SignUp() {
    return (
        <div className="flex flex-col justify-center items-center bg-white md:absolute md:top-0 w-full z-0">
            <div className="mx-auto flex w-full flex-col justify-center px-5 pt-0 md:max-w-1/2 lg:h-screen min-h-screen lg:max-w-1/2 lg:px-6">
                ...
                <p className="text-2xl font-bold text-zinc-950 dark:text-white">Sign Up</p>
                <p className="mb-2.5 mt-2.5 text-zinc-950 dark:text-zinc-400">Enter your email and password to sign in!</p>
                <div className="mt-8">
                    <form className="pb-2">
                ...
                <div>
                    ...
                    <div className="grid gap-2">
                        ...
                        <label className="text-zinc-950 dark:text-white" htmlFor="email">Username</label>
                        <input
                    ...
                    <p><Link href="/login" className="font-medium text-zinc-950 dark:text-white text-sm">Already have an account? <span className="text-blue-500">Login</span></Link></p>
                </div>
                </div>
            </div>
        </div>
